    ...
    <div class="col-lg-12 container contant-wraper">
        ...
        <div id="divToPrint">
            ...
            <div style="text-align:center;">
                ...
                <h4>Handling & Transport Charges Collection Between: <?php echo date('d-m-Y',strtotime($from_date)); ?> To <?php echo date('d-m-Y',strtotime($todate)); ?></h4>
                <!-- <h5 style="text-align:left"><label>District: </label> <?php //echo $branch->district_name; ?></h5> -->

            </div>
          
            <label> &nbsp;&nbsp;(Code:BR016) </label><br>
...
buttons: [
   {
extend: 'excelHtml5',
title: 'Handling & Transport Charges',
