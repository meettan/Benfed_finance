...
<div class="wraper">
    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-sm-12">
            ...
            <h2><strong>Handling & transport charges Customer List</strong></h2>
    ...
    <div class="col-lg-12 container contant-wraper">
        ...
        <a href="<?php echo site_url("dashboard"); ?>" 
            ...
            <a href="<?php echo site_url("handling-trandport-charges/customar_entry"); ?>" class="btnSame btn-primary" style="width: 100px;">Add</a>
