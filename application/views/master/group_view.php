...
<div class="wraper">
    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-sm-12">
            ...
            <h2><strong>Group Master</strong></h2>
    ...
    <div class="col-lg-12 container contant-wraper">
        ...
        <a href="<?php echo site_url("dashboard"); ?>" 
            ...
            <a href="<?php echo site_url("group/entry"); ?>" class="btnSame btn-primary" style="width: 100px;">Add</a>
