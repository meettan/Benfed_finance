    ...
    <div class="wraper">
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-sm-12">
                ...
                <h2><strong>Print Bank Vouchers</strong></h2>
        ...
        <div class="col-lg-12 container contant-wraper">
		    ...
		    <div class="search-row row" style="margin-top:10px">
			<form method="POST" action="<?php echo site_url("transaction/approvedbankvoucher") ?>" >
                ...
                <tbody>
                    ...
                    ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                              <a href="<?php echo site_url('report/bankjrnlprn?voucher_id='.$value->voucher_id.''); ?>" title="Print">
