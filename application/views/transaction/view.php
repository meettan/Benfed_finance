...
<div class="wraper">
    ...
    <div class="row">
        <div class="col-lg-9 col-sm-12">
            <h2><strong>Unapproved Cash Vouchers</strong></h2>
        </div>
    </div>
                ...
                <?php if($row): ?>
                    <?php foreach($row as $value): ?>
                        <tr>
                            ...
                            <td><?= ($value->voucher_mode=="C") ? "Cash" : (($value->voucher_mode=="B") ? "Bank" : "Transfer") ?></td>
                            <td><?= $value->amount ?></td>
                            ...
                            <?php } ?></td>
                            <td>
                                <a href="<?= site_url() ?>/transaction/edit?id=<?= $value->voucher_id ?>">
                                    <i class="fa fa-edit fa-2x" style="color:#1565c0"></i>
                                </a>
                            </td>
                            <td>
                                <?php if($value->voucher_mode != 'A'): ?>
                                    <button type="button" class="delete" id="<?= $value->voucher_id ?>">
