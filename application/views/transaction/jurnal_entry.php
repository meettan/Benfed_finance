        ...
        $("#newrow").click(function() {
            if ($('#v_type').val() != '') {
                ...
                $("#add").append('<tr class="mb-2"><td><select id="acc_code_' + x + '" name="acc_code[]" class="form-control acc_code select2 creditAcoCode" style="width: 80%;" onchange="set_gr(' + x + ')" required><option value="">Select</option>' +
                    ...
                    '<td><h5>Credit</h5><input type = "hidden" id = "dc_flg" name = "dc_flg[]" class = "transparent_tag" style = "width: 100%; text-align: center;" value = "Credit" readonly required ></td>' +
            ...
            <table id="debit_vau_tab">
                ...
                <tbody id="debitadd">
                    <tr>
                        ...
                        <td><input type="text" class="transparent_tag" id="gr_id_Debit_1" name="gr_id_Debit[]" style="width: 100%;" readonly></td>
                        <td><input type="text" class="transparent_tag" id="subgr_id_Debit_1" name="subgr_id_Debit[]" style="width: 100%;" readonly></td>
                        <td><input type="text" class="form-control amount_cls_Debit" id="amt" name="amount_Debit[]" style="width: 100%; text-align: right;"  oninput="validate(this)"  required></td>
                        <!-- <td></td> -->
