...
<div class="wraper">
    ...
    <div class="col-md-9 container form-wraper">
        ...
        <form method="POST" action="<?php echo site_url("transaction/jurnal_approve") ?>" onsubmit="return valid_data()">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    ...
                    <span style="float: right; display: inline;">
                        <input type="text" id="dc" class="transparent_tag" name="dr_cr_flag" value="<?= $head_tag['dr_cr_flag'] == 'Dr' ? 'Debit' : 'Credit' ?>" readonly>
                    </span>
