<div class="wraper">
    <div class="col-md-10 container form-wraper">
        <form method="POST" action="<?php echo site_url("api/get_api_res_cr");?> " onsubmit="">
            ...
            <div class="form-group row">
                ...
                <label for="ac_type" class="col-sm-2 col-form-label">Invoice Number:</label>
                <div class="col-sm-4">
                    <input type="text" value="<?php echo $rntcledite->invoice_no;  ?>" class="form-control" id="invoice_no"
                        name="invoice_no" readonly required />
                </div>
            </div>
            <div class="form-group row">
            ...
            <!-- <div class="form-group row">
               <label for="trans_dt" class="col-sm-2 col-form-label">Reason:</label>
                <div class="col-sm-10">
