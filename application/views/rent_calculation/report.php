    ...
    <div class="col-lg-12 container contant-wraper">
        ...
        <div id="divToPrint">
            ...
            <div style="text-align:center;">
                ...
                <h4>Rent Collection Between: <?php echo date('d-m-Y',strtotime($from_date)); ?> To <?php echo date('d-m-Y',strtotime($todate)); ?></h4><span style="float:left; font-weight:bold; font-size:16px;">
    Code: BR015
</span>
